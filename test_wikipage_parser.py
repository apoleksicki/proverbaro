...
def test_simple_li():
    _simple_test('Aliloka ĉielo estas sama ĉielo.', '<li>Aliloka ĉielo estas sama ĉielo.</li>')
...
def test_li_with_multiple_href():
    to_parse = '<li>Vivi en <a href="/wiki/Silko" title="Silko">silko</a> kaj <a href="/wiki/Veluro" title="Veluro">veluro</a>, en <a href="/wiki/%C4%9Cojo" title="Ĝojo">ĝojo</a> kaj <a href="/wiki/Plezuro" title="Plezuro">plezuro</a>.</li>'
